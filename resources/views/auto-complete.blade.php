...
<html lang="en">
<head>
<title>ReasonDigital Weather API</title>
<meta charset="utf-8">
...
<h5 class="card-title text-white"> ReasonDigital Weather API</h5>
</div>
<div class="card-body">
...
<button type="submit" name="goweather" class="btn btn-success" onclick="myweatherapi()"> Get Today's Weather Update. </button>
</div>
</div>
</div>
</div>
